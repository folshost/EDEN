...
public class WeatherMonitor {
    private final static String APIKey = "http://api.openweathermap.org/data/2.5/weather?id=4323288&APPID=c21a3eaefc11b898ce1dc12ecdfae4db&mode=xml&units=imperial";
    protected boolean errorCheck; // This will be used to see whether an Alert needs to be created
    protected AlertType type; //Here, AlertType should be an enum used to talk about each different
